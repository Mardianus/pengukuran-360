<div class="">
    ...
    <input type="text" style="margin: 5" class="form-control" name="tingkat Jabatan" placeholder="Tingkat Jabatan">
</div>
        ...
        <tr>
            ...
            <td class="text-center">
                <div class="btn-group">
                    ...
                    <a class="btn btn-default btn-xs btn-danger" onclick="Delete('<?= $value->id ?>', '<?= $value->level ?>')" data-toggle="tooltip" data-placement="bottom" title="Delete data karyawan"><i class="glyphicon glyphicon-trash" data-toggle="modal" data-target="#Deletemodal"></i></a>
                </div>
            </td>
        </tr>
    <?php } ?>
